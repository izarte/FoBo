...
: ${AMENT_CURRENT_PREFIX:="/usr/src/ros2_ws/install/fobo_yolo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fobo_yolo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fobo_yolo/environment/path.sh"
